        ...
        <svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 200">
            <defs>
                <linearGradient id="gold-gradient" x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop offset="0%" style={{ stopColor: '#724e41', stopOpacity: 1 }} />
                    <stop offset="50%" style={{ stopColor: '#724e41', stopOpacity: 1 }} />
                    <stop offset="100%" style={{ stopColor: '#724e41', stopOpacity: 1 }} />
                </linearGradient>
            </defs>
